...
namespace Aspire\Module\Model\Config;
...
class CronConfig extends \Magento\Framework\App\Config\Value
{
     ...
     */
    const CRON_STRING_PATH = 'crontab/default/jobs/aspire_cron_setup_job/schedule/cron_expr';

    /**
     * Cron model path constant
     */
    const CRON_MODEL_PATH = 'crontab/default/jobs/aspire_cron_setup_job/run/model';
